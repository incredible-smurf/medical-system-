<template>
  <el-main>
    ...
    <el-table :data="templatelist" style="width: 100%">
      <el-table-column label="主诊报告ID" prop="id"> </el-table-column>
...
export default {
  ...
  beforeCreate() {
    ...
    this.$axios
      .get("/diagnosisReportLC/", { params: { category: 1 } })
      .then((res) => {
        //console.log(res);
  ...
  methods: {
    ...
    handleEdit(index, row) {
      this.$router.push({
        path: "/main-diagnosis/show-main-diagnosis-detail",
        query: { id: row.id },
      });
    },
  },
